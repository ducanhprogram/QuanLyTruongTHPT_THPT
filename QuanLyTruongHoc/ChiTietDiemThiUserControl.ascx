<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietDiemThiUserControl.ascx.cs" Inherits="QuanLyTruongHoc.ChiTietDiemThiUserControl" %>
    ...
    <div class="container p-md-4 p-sm-4">
        ...
        <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
            <div class="col-md-6">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Vui lòng chọn môn học."
            ...
            <div class="col-md-6">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Vui lòng chọn học sinh."
